package com.gabriel.iosefbinica.spring.security.jwt.security.jwt;
...
public class JwtUtils {
  ...
  @Value("${gabriel.iosefbinica.app.jwtSecret}")
  private String jwtSecret;

  @Value("${gabriel.iosefbinica.app.jwtExpirationMs}")
  private int jwtExpirationMs;

  @Value("${gabriel.iosefbinica.app.jwtCookieName}")
  private String jwtCookie;
  
  @Value("${gabriel.iosefbinica.app.jwtRefreshCookieName}")
